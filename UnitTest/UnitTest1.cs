...
namespace UnitTest
{
    ...
    public class UnitTest1
    {
        ...
        public void GetPreview()
        {
            ...
            fields.Add(new FieldModel("department", 125, 112, 105, 1280,FieldModel.DataTypes.LIST));
            fields.Add(new FieldModel("province", 236, 112, 105, 1280, FieldModel.DataTypes.LIST));
            fields.Add(new FieldModel("district", 324, 115, 220, 1280, FieldModel.DataTypes.LIST));
